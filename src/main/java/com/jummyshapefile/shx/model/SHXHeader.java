...
import com.jummyshapefile.shx.SHXParameters;

/**
 * Represents the header of a SHX file.
 * <p>
 * https://en.m.wikipedia.org/wiki/Shapefile
 */
public class SHXHeader extends BinaryFileHeader {
	private final int headerSize = SHXParameters.SHX_HEADER_LENGTH;
	private final int recordSize = SHXParameters.SHX_RECORD_LENGTH;
